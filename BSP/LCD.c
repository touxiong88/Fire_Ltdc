...
//	SPI_SendData(0x01,0x21);
	...
	SPI_SendData(0x03,0x2E);
	SPI_SendData(0x04,0x6F);
	SPI_SendData(0x05,0x87);
	SPI_SendData(0x06,0x80);
	SPI_SendData(0x07,0x90);
	SPI_SendData(0x08,0x1B);
	SPI_SendData(0x09,0x00);
	...
	SPI_SendData(0x16,0xB4);
	SPI_SendData(0x17,0x00);
	SPI_SendData(0x18,0x88);
